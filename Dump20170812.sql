...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_comments_users1` FOREIGN KEY (`users_id  `) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `families` VALUES (1),(2),(3),(4),(5),(6);
...
INSERT INTO `users` VALUES ('admin','admin','admin',1),('test1','test1','test1',6);
...
-- Dump completed on 2017-08-12 19:37:12
